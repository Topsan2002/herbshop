                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                                ...
                                <div class="col-md-2">
                                            <a class="btn btn-success mr-0 ml-5 text-center" href="index.php?p=manage_cate">เพิ่มประเภท</a>
                                </div>
                        </div>
                            ...
                            <table class="display" id="basic-1">
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        $query = $conn->query("SELECT * FROM tb_category WHERE del_status = '0' " );
                                        $i =1;
                                    ...
                                    <tr>
                                        <td><?php echo $i++; ?></td>
                                        <td>
                                            <h6><?php echo $fet->cat_name ?></h6>
                                           
                                        </td>
                                      
                                        <td>
                                            <a class="btn btn-info mr-3" href="index.php?p=manage_cate&cat_id=<?php echo $fet->cat_id; ?>">แก้ไข</a>

                                            <!-- <a class="btn btn-danger mr-3" href="index.php?p=edit_product">ลบ</a> -->
                                            <button class="btn btn-danger" type="button" onclick="return deleteCate(<?php echo $fet->cat_id; ?>)">ลบ</button>
                                        </td>
                                    </tr>
...
function deleteCate(id) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "api/api_cate.php",
                type: "POST",
                dataType: "JSON",
                data: "ac=" + 'del' + "&cat_id=" + id,
