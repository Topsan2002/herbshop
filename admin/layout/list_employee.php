                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                                ...
                                <div class="col-md-2">
                                            <a class="btn btn-success mr-0 ml-5 text-center" href="index.php?p=add_emp">เพิ่มพนักงาน</a>
                                </div>
                        </div>
                            ...
                            <table class="display" id="basic-1">
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        $query = $conn->query("SELECT * FROM tb_employee WHERE del_status = '0' " );
                                        $i = 1;
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $i++ ?></td>
                                        <td class="font-success"><?php echo $fet->fname." ".$fet->lname ?></td>
                                        <td><?php echo $fet->email ?></td>
                                        <td><?php echo $fet->phone ?></td>
                                        <td>
                                            <a class="btn btn-info mr-3" href="index.php?p=add_emp&emp_id=<?php echo $fet->emp_id; ?>">แก้ไข</a>

                                            <!-- <a class="btn btn-danger mr-3" href="index.php?p=edit_product">ลบ</a> -->
                                            <button class="btn btn-danger" type="button" onclick="return del(<?php echo $fet->emp_id; ?>)">ลบ</button>
                                        </td>
                                    </tr>
