                        ...
                        <div class="auth-innerright auth-minibox">
                            <div class="authentication-box auth-minibox1">
                                ...
                                <div class="card mt-10 p-10">
                                    <h5 class="f-20 mb-3 f-w-600">ลืมรหัสผ่านหรือไม่</h5>
                                    <form class="theme-form" action="../api/api_mail.php" method="POST" id="form_forget">
                                        <div class="form-group">
                                            <label class="col-form-label">ป้อนที่อยู่อีเมลของคุณด้านล่างและเราจะส่งลิงก์ของคุณเพื่อรีเซ็ตรหัสผ่านของคุณ</label>
