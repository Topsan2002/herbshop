                        ...
                        <div class="order-history table-responsive wishlist">
                            <table class="table table-bordernone">
                                ...
                                ?>
                                    ...
                                    <tr>
                                        <td><img class="img-fluid img-60" style="width: 100px; height: 100px; object-fit: cover;" src="images/product/<?php echo $fet->pro_pic ?>" alt="#"></td>
                                        <td>
                                            <div class="product-name"><a href="index.php?p=product_page&pro_id=<?php echo $fet->pro_id; ?>"><?php echo $fet->pro_name ?></a></div>
                                        </td>
                                        ...
                                        <td>
                                            <button onclick="return delChart(<?php echo $i; ?>);"> <i data-feather="x-circle"> </i>
                                            </button></td>
                                ...
                                <?php
                                    ...
                                    <tr>
                                        <td colspan="5"><a class="btn btn-primary cart-btn-transform" href="index.php?p=dashboard">เลือกสินค้าอื่นต่อ</a></td>
                                        <td><a href="index.php?p=checkout"><button class="btn btn-primary cart-btn-transform">สั่งซื้อสินค้า</button></a></td>
                                        <!-- <td><button class="btn btn-primary cart-btn-transform" onclick="return sendOrder()">check out</button></td> -->
                                    </tr>
